...
class PessoaJuridica(Pessoa):
    ...
    def calcular_imposto(self, rendimento: float) -> float:
        # Sem imposto para rendimentos até 15000
        if rendimento <= 15000:
            return 0
        # 2% de imposto para rendimento entre 15000 e 35000
        elif 1500 < rendimento <= 35000:
            return (rendimento / 100) * 2
        # 3.5% de imposto para rendimentos entre 35000 e 60000
        elif 3500 < rendimento <= 60000:
            return (rendimento / 100) * 3.5
        # 5% de impostos para rendimentos acima de 60000
        else: 
            return rendimento * 5